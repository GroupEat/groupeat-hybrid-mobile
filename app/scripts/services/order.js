...
angular.module('groupeat.services.order', [
  ...
  var resource = $resource(ENV.apiEndpoint + '/orders/:id'), fromGroupOrderResource = $resource(ENV.apiEndpoint + '/customers/:customerId/groupOrders/:groupOrderId/orders?include=restaurant'), forCustomerResource = $resource(ENV.apiEndpoint + '/customers/:customerId/orders?include=groupOrder.restaurant');
  var currentOrder = {
      'groupOrderId': null,
      'endingAt': null,
      ...
      var defer = $q.defer();
      resource.get({ id: orderId }).$promise.then(function (response) {
      ...
      var defer = $q.defer();
      forCustomerResource.get({ customerId: customerId }).$promise.then(function (response) {
