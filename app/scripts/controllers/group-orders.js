...
angular.module('groupeat.controllers.group-orders', [
  ...
  $scope.initCtrl = function () {
    ...
    $scope.onRefreshGroupOrders().finally(function () {
  ...
  $scope.onRefreshGroupOrders = function () {
    ...
    if (!Network.hasConnectivity()) {
      ...
      Geolocation.getGeolocation().then(function (currentPosition) {
        ...
        GroupOrder.get($scope.userCurrentPosition.coords.latitude, $scope.userCurrentPosition.coords.longitude).then(function (groupOrders) {
          deferred.resolve();
