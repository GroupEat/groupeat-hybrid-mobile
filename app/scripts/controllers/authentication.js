...
.controller('AuthenticationCtrl', function (_, $filter, $ionicSlideBoxDelegate, $q, $scope, $state, $stateParams, $timeout, Analytics, Authentication, Credentials, Customer, DeviceAssistant, ElementModifier, Network, Popup) {
