...
angular.module('groupeat.directives.header-shrink', []).directive('headerShrink', function ($document, $timeout) {
  return {
    ...
    link: function(scope, element, attr) {
      ...
      $timeout(function () {
        navbar = $document[0].body.querySelector('.bar-header');
        ...
        var scrollTop = e.originalEvent.detail.scrollTop;
          if (scrollTop >= 0) {
            ...
            navbar.style.backgroundColor = 'rgba(48,54,76,' + backgroundAmt + ') !important';
            ...
            navbar.style.backgroundColor = 'rgba(48,54,76,0) !important';
