...
.factory('DeviceAssistant', function(_, $ionicPlatform, $q, $resource, $rootScope, apiEndpoint, Credentials, PushNotification) {

  var

  resource = $resource(apiEndpoint + '/customers/:id/devices'),
