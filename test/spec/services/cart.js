...
describe('Service: Cart', function () {
  ...
  var Cart, scope, httpBackend;

  // Initialize the controller and a mock scope
  beforeEach(inject(function ($rootScope, $httpBackend, _Cart_, _) {
    scope = $rootScope.$new();
  ...
  describe("Cart Service contents :", function() {
    it("should create an objet of products", function() {
      expect(Cart.products).not.to.equal(null);
    });

  });

  describe("Cart Service methods :", function(){
    ...
    it("should refresh empty cart", function() {
      var testCart = Cart.getCart();
    ...
    it("refreshCart should update prices and quantities of cart and childrens", function() {
      var testCart = Cart.getCart();
      testCart.productsItems = [{
        'id': 12,
        'name': 'test name',
    ...
    it("should delete productsItems when a product total quantity equals 0", function(){
      var testCart = Cart.getCart();
    ...
    it("should remove product by decreasing quantity", function() {
      var testCart = Cart.getCart();
    ...
    it("should add an existing product", function() {
      var testCart = Cart.getCart();
      testCart.productsItems = [{
        'id': 12,
        'name': 'test name',
      ...
      var productToAdd = { // data coming from restaurant menu alias pizzas*.json
        'name': 'test name',
    ...
    it("should add a new product in cart", function() {
      var testCart = Cart.getCart();
